...
import { Button, LoadingSpinner, Icon } from '../common';
  ...
  return (
    <div className="landing-page">
      <div className="landing-content">
        ...
        <p className="landing-tagline">Track & organize your collections</p>

        {/* Features */}
        <div className="landing-features">
          <div className="feature">
            <Icon name="layers" size={24} color="var(--color-accent)" />
            <span>9 collection types</span>
          </div>
          <div className="feature">
            <Icon name="camera" size={24} color="var(--color-secondary)" />
